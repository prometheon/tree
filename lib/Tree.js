...
var Tree = /*#__PURE__*/function (_React$Component) {
  ...
  function Tree() {
    ...
    _this.onNodeDragOver = function (event, node) {
      ...
      if (eventKey === _this.state.dragOverNodeKey) {
    ...
    _this.createEventNode = function (key, itemData) {
      ...
      var eventNode = (0, _treeUtil.convertNodePropsToEventData)(_objectSpread({}, (0, _treeUtil.getTreeNodeProps)(uniqueKey, treeNodeRequiredProps), {
        data: _objectSpread({
          key: uniqueKey
        }, itemData)
      }));
    ...
    _this.onNodeDrop = function (event, node) {
      ...
      if (_this.dragNode) {
        dropResult.dragNode = (0, _treeUtil.convertNodePropsToEventData)(_this.dragNode.props);
      }
    ...
    _this.onKeyDown = function (event) {
      ...
      var _this$props6 = _this.props,
          ...
          selectable = _this$props6.selectable; // >>>>>>>>>> Direction
